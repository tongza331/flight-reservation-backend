# Generated by Django 3.2.9 on 2021-11-20 10:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('destination', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='arrivals', to='flightapp.location')),
                ('origin', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='departures', to='flightapp.location')),
            ],
            options={
                'db_table': 'ticket',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('flight', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='tickets', to='flightapp.ticket')),
                ('passenger', models.ManyToManyField(blank=True, related_name='flight_tickets', to='flightapp.Passenger')),
